...
const Stats = () => (
  <section className="" id="Happyjacks Gallery">
    <div className="h-screen my-10 card text-center bg-base-100 shadow-xl">
      <div className=" card-body text-5xl gap-10 font-extrabold">
