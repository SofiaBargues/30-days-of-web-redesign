...
export const Hero = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col-2 hero text-neutral-content">
        <div className="flex flex-col justify-start  m-20  gap-5 ">
          <h1 className=" text-white text-7xl mt-10 font-bold">JIGSAW</h1>
